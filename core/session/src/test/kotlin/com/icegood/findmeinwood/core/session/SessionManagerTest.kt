...
class SessionManagerTest {
    ...
    fun `onFrameReceived fires with decrypted payload and sender`() = runBlocking {
        ...
        try {
            ...
            val decoded = com.icegood.findmeinwood.core.model.PayloadCodec.decode(received!!.first)
            kotlin.test.assertTrue(decoded is com.icegood.findmeinwood.core.model.BeaconPayload)
        } finally { mA.stop(); mB.stop(); scope.cancel() }
    }
}
