...
class PeerTrackerTest {
    ...
    private fun beacon(seq: UInt, withPos: Boolean = true) = DecryptedBeacon(
        ...
        payload = BeaconPayload(
            position = if (withPos) app.findmeinwood.core.model.BeaconPosition(1, 2, 3, 4) else null,
        ),
    )
...
class BeaconSchedulerTest {
    ...
    private fun fix(i: Int) = app.findmeinwood.core.model.GnssFix(1.0 * i, 2.0, 1f, 3.0, i.toLong())
}
